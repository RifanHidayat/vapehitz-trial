...
require_once 'service/Apprvretail_Service.php';

class ApprvretailController extends Zend_Controller_Action {

    public function init() {
        $registry = Zend_Registry::getInstance();
        $this->auth = Zend_Auth::getInstance();
        $this->Home_Service = Home_Service::getInstance();
		$this->Apprvretail_Service = Apprvretail_Service::getInstance();
    ...
    public function indexAction() {
        ...
        $this->_helper->layout->setLayout('apprvretail-layout');
		
		$this->view->Apprvretail_Service = $this->Apprvretail_Service;
		
		$this->view->data = $this->Apprvretail_Service->getlist();
		$this->view->menu = $this->Apprvretail_Service->getmenu();
    }
	...
	public function tambahdataAction() {
		...
		$this->view->supplier=$this->Apprvretail_Service->getSupplier();
		$this->view->warna=$this->Apprvretail_Service->getWarna();
		$this->view->seq=$this->Apprvretail_Service->getNoSeq();
		$this->view->rek=$this->Apprvretail_Service->getRekening();
    }
	...
	public function dataatomizerAction(){
		...
		$this->view->data = $this->Apprvretail_Service->getlistatomizer();
    }
	...
	public function dataaksesorisAction(){
		...
		$this->view->data = $this->Apprvretail_Service->getlistaccessories();
    }
	...
	public function datadeviceAction(){
		...
		$this->view->data = $this->Apprvretail_Service->getlistdevice();
    }
	...
	public function dataliquidAction(){
		...
		$this->view->data = $this->Apprvretail_Service->getlistliquid();
    }
	...
	public function kirimdataAction() { 
		...
		$data = array('no_request' => $no_request,
					  ...
					  'kode' => $kode);
		//var_dump($data);
		$this->view->datainsert=$this->Apprvretail_Service->insertdata($data);
   }
   ...
   public function hapusdataAction(){
		...
		$hasil = $this->Apprvretail_Service->hapusData($dataInput);
	...
	public function editdataAction() {
		...
		$this->view->data=$this->Apprvretail_Service->getDatareqtoretail($no_request_data);
		
		$this->view->data3=$this->Apprvretail_Service->getDataDetailreqtoretail($no_request_data);
	...
	public function kirimdataeditAction() { 
		...
		$this->view->datainsert=$this->Apprvretail_Service->editdata($data);
   }
   ...
   public function approvalAction() {
	...
	public function kirimdataapproveAction() { 
		...
		$this->view->datainsert=$this->Apprvretail_Service->approvedata($data);
   }
   ...
   public function kirimdataapprove2Action() { 
		...
		$this->view->datainsert=$this->Apprvretail_Service->approvedata2($data);
   }
