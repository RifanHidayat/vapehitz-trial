...
class AccessoriesController extends Zend_Controller_Action
{
	...
	public function kirimdataAction()
	{
		...
		if (isset($_POST['jenis_aksesoris'])) {
			$jenis_aksesoris = $_POST['jenis_aksesoris'];
		}
		if (isset($_POST['kode_aksesoris'])) {
			$kode_aksesoris  = $_POST['kode_aksesoris'];
		}
	...
	public function hapusdataAction()
	{
		...
		if (isset($_REQUEST['kode_aksesoris'])) {
			$kode_aksesoris = $_REQUEST['kode_aksesoris'];
		}
