...
class AtomizerController extends Zend_Controller_Action
{
	...
	public function kirimdataAction()
	{
		...
		if (isset($_POST['kode_atomizer'])) {
			$kode_atomizer = $_POST['kode_atomizer'];
		}
		if (isset($_POST['id_kode_barang'])) {
			$id_kode_barang = $_POST['id_kode_barang'];
		}
		if (isset($_POST['seq_kode_barang'])) {
			$seq_kode_barang = $_POST['seq_kode_barang'];
		}
		if (isset($_POST['merk_atomizer'])) {
			$merk_atomizer = $_POST['merk_atomizer'];
		}
		if (isset($_POST['nama_atomizer'])) {
			$nama_atomizer = $_POST['nama_atomizer'];
		}
		if (isset($_POST['jenis_atomizer'])) {
			$jenis_atomizer = $_POST['jenis_atomizer'];
		}
		if (isset($_POST['kode_warna'])) {
		...
		if (isset($_POST['otorisasi_harga'])) {
			$otorisasi_harga = $_POST['otorisasi_harga'];
		}
	...
	public function hapusdataAction()
	{
		...
		if (isset($_REQUEST['kode_atomizer'])) {
			$kode_atomizer = $_REQUEST['kode_atomizer'];
		}
	...
	public function cekseqAction()
	{
		...
		$id_kode_barang = '';
		if (isset($_REQUEST['id_kode_barang'])) {
			$id_kode_barang = $_REQUEST['id_kode_barang'];
		}
