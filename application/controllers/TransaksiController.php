...
require_once 'service/Transaksi_Service.php';

class TransaksiController extends Zend_Controller_Action {

    public function init() {
        $registry = Zend_Registry::getInstance();
        $this->auth = Zend_Auth::getInstance();
        $this->Home_Service = Home_Service::getInstance();
		$this->Transaksi_Service=Transaksi_Service::getInstance();
    ...
    public function indexAction() {
        ...
        $this->_helper->layout->setLayout('transaksi-layout');
		
		$this->view->Transaksi_Service = $this->Transaksi_Service;
		
		$this->view->data = $this->Transaksi_Service->getlistliquid();
		
		$this->view->menu = $this->Transaksi_Service->getmenu();
		$this->view->seq  = $this->Transaksi_Service->getNoSeq();
    }
	...
	public function tambahdataAction() {
		...
		$this->view->supplier=$this->Transaksi_Service->getSupplier();
		$this->view->rasa=$this->Transaksi_Service->getRasa();
		$this->view->seq=$this->Transaksi_Service->getNoSeq();
    }
		...
		$volume = str_replace(".", "", $volume);
		 ...
		 $data = array(
		 				...
		 				"tgl_transaksi" => $tgl_transaksi,
                      	"jenis_expense" => $jenis_expense,
                       	"nominal" => $nominal,
                       	"catatan" => $catatan,
                       	"nama_akun" => $nama_akun,
                       	"type" => $type);
		if($action == 'tambah'){
			$this->view->datainsert=$this->Transaksi_Service->insertdata($data);
		} else {
			$this->view->datainsert=$this->Transaksi_Service->editdata($data);
		}
   ...
   public function hapusdataAction(){
		...
		$hasil = $this->Transaksi_Service->hapusData($dataInput);
	...
	public function editdataAction() {
		...
		$this->view->data=$this->Transaksi_Service->getDataLiquid($id);
		$this->view->jenis_expense = $this->Transaksi_Service->getlistjenisexpense();
		$this->view->akun = $this->Transaksi_Service->getlistakun();
		$this->view->Transaksi_Service = $this->Transaksi_Service;
    }
    ...
    public function detaildataAction() {
		...
		$this->view->data=$this->Transaksi_Service->getDataLiquid($id);
		$this->view->transaksi=$this->Transaksi_Service->getDataTransaksi($id);
		$this->view->jenis_expense = $this->Transaksi_Service->getlistjenisexpense();
		$this->view->akun = $this->Transaksi_Service->getlistakun();
		$this->view->Transaksi_Service = $this->Transaksi_Service;
    }
	...
	public function cekseqAction(){
		...
		$this->view->id_id_volume = $this->Transaksi_Service->getSeq($id_id_volume);
	}
