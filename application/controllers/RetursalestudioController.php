...
require_once 'service/Retursalestudio_Service.php';

class RetursalestudioController extends Zend_Controller_Action {

    public function init() {
        $registry = Zend_Registry::getInstance();
        $this->auth = Zend_Auth::getInstance();
        $this->Home_Service = Home_Service::getInstance();
		$this->Retursalestudio_Service = Retursalestudio_Service::getInstance();
    ...
    public function indexAction() {
        ...
        $this->_helper->layout->setLayout('retursalestudio-layout');
		
		$this->view->Retursalestudio_Service = $this->Retursalestudio_Service;
		
		$this->view->data = $this->Retursalestudio_Service->getlistsalestudio();
		$this->view->menu = $this->Retursalestudio_Service->getmenu();
    }
	...
	public function historyAction() {
		...
		$this->view->data = $this->Retursalestudio_Service->getlistReturPenjualan();
    }
	...
	public function tambahdataAction() {
		...
		$this->view->supplier=$this->Retursalestudio_Service->getCustomer();
		$this->view->warna=$this->Retursalestudio_Service->getWarna();
		$this->view->seq=$this->Retursalestudio_Service->getNoSeq();
		$this->view->rek=$this->Retursalestudio_Service->getRekening();
			$this->view->cash=$this->Retursalestudio_Service->getCash();
    }
	...
	public function dataatomizerAction(){
		...
		$this->view->data = $this->Retursalestudio_Service->getlistatomizer();
    }
	...
	public function dataaksesorisAction(){
		...
		$this->view->data = $this->Retursalestudio_Service->getlistaccessories();
    }
	...
	public function datadeviceAction(){
		...
		$this->view->data = $this->Retursalestudio_Service->getlistdevice();
    }
	...
	public function databarangAction(){
		...
		$this->view->data = $this->Retursalestudio_Service->getDataDetailsalestudio($no_invoice_data);
    }
	...
	public function kirimdataAction() { 
		...
		$data = array('kode_customer' => $kode_customer,
					  ...
					  'kode' => $kode);
		//var_dump($data);
		$this->view->datainsert=$this->Retursalestudio_Service->insertdata($data);
   }
   ...
   public function hapusdataAction(){
		...
		$hasil = $this->Retursalestudio_Service->hapusData($dataInput);
	...
	public function editdataAction() {
		...
		$this->view->data=$this->Retursalestudio_Service->getDatasalestudio($no_invoice_data);
		/* $temp_ordercentral = $this->Retursalestudio_Service->getDatasalestudio($no_invoice_data);
		$kode_customer = $temp_ordercentral[0]['kode_customer'];
		$this->view->data2 = $this->Retursalestudio_Service->getdatacustomerid($kode_customer); */
		
		$this->view->data3=$this->Retursalestudio_Service->getDataDetailsalestudio($no_invoice_data);
		
		$this->view->data4=$this->Retursalestudio_Service->getDataDetailHutang($no_invoice_data);
	...
	public function kirimdataeditAction() { 
		...
		$this->view->datainsert=$this->Retursalestudio_Service->editdata($data);
   }
   ...
   public function detailAction() {
		...
		$this->view->data=$this->Retursalestudio_Service->getDatasalestudio($no_invoice_data);
		$temp_salestudio = $this->Retursalestudio_Service->getDatasalestudio($no_invoice_data);
	...
	public function detailreturAction() {
		...
		$this->view->data=$this->Retursalestudio_Service->getDataReturPenjualan($no_retur_data);
		/* $temp_salestudio = $this->Retursalestudio_Service->getDataReturPenjualan($no_retur_data);
		$kode_customer = $temp_salestudio[0]['kode_customer'];
		$this->view->data2 = $this->Retursalestudio_Service->getdatacustomerid($kode_customer); */
		
		$this->view->data3=$this->Retursalestudio_Service->getDataDetailReturPenjualan($no_retur_data);
