...
class DeviceController extends Zend_Controller_Action
{
	...
	public function kirimdataAction()
	{
		...
		if (isset($_POST['jenis_device'])) {
			$jenis_device = $_POST['jenis_device'];
		}
		if (isset($_POST['kode_device'])) {
		...
		if (isset($_POST['merk_device'])) {
			$merk_device = $_POST['merk_device'];
		}
		if (isset($_POST['nama_device'])) {
	...
	public function hapusdataAction()
	{
		...
		if (isset($_REQUEST['kode_device'])) {
			$kode_device = $_REQUEST['kode_device'];
		}
