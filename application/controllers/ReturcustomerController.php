...
require_once 'service/Returcustomer_Service.php';

class ReturcustomerController extends Zend_Controller_Action {

    public function init() {
        $registry = Zend_Registry::getInstance();
        $this->auth = Zend_Auth::getInstance();
        $this->Home_Service = Home_Service::getInstance();
		$this->Returcustomer_Service = Returcustomer_Service::getInstance();
    ...
    public function indexAction() {
        ...
        $this->_helper->layout->setLayout('returcustomer-layout');
		
		$this->view->Returcustomer_Service = $this->Returcustomer_Service;
		
		$this->view->data = $this->Returcustomer_Service->getlistSaleCentral();
		$this->view->menu = $this->Returcustomer_Service->getmenu();
    }
	...
	public function historyAction() {
		...
		$this->view->data = $this->Returcustomer_Service->getlistReturPenjualan();
    }
	...
	public function tambahdataAction() {
		...
		$this->view->supplier=$this->Returcustomer_Service->getCustomer();
		$this->view->warna=$this->Returcustomer_Service->getWarna();
		$this->view->seq=$this->Returcustomer_Service->getNoSeq();
		$this->view->rek=$this->Returcustomer_Service->getRekening();
		$this->view->rek=$this->Returcustomer_Service->getCash();
    }
	...
	public function dataatomizerAction(){
		...
		$this->view->data = $this->Returcustomer_Service->getlistatomizer();
    }
	...
	public function dataaksesorisAction(){
		...
		$this->view->data = $this->Returcustomer_Service->getlistaccessories();
    }
	...
	public function datadeviceAction(){
		...
		$this->view->data = $this->Returcustomer_Service->getlistdevice();
    }
	...
	public function databarangAction(){
		...
		$this->view->data = $this->Returcustomer_Service->getDataDetailSaleCentral($no_invoice_data);
    }
	...
	public function kirimdataAction() { 
		...
		$data = array('kode_customer' => $kode_customer,
					  ...
					  'kode' => $kode);
		//var_dump($data);
		$this->view->datainsert=$this->Returcustomer_Service->insertdata($data);
   }
   ...
   public function hapusdataAction(){
		...
		$hasil = $this->Returcustomer_Service->hapusData($dataInput);
	...
	public function editdataAction() {
		...
		$this->view->data=$this->Returcustomer_Service->getDataSaleCentral($no_invoice_data);
		$temp_ordercentral = $this->Returcustomer_Service->getDataSaleCentral($no_invoice_data);
		$kode_customer = $temp_ordercentral[0]['kode_customer'];
		$this->view->data2 = $this->Returcustomer_Service->getdatacustomerid($kode_customer);
		
		$this->view->data3=$this->Returcustomer_Service->getDataDetailSaleCentral($no_invoice_data);
		
		$this->view->data4=$this->Returcustomer_Service->getDataDetailHutang($no_invoice_data);
		
		$this->view->supplier=$this->Returcustomer_Service->getCustomer();
		$this->view->warna=$this->Returcustomer_Service->getWarna();
		$this->view->seq=$this->Returcustomer_Service->getNoSeq();
		$this->view->rek=$this->Returcustomer_Service->getRekening();
		$this->view->cash=$this->Returcustomer_Service->getCash();
    }
	...
	public function kirimdataeditAction() { 
		...
		$this->view->datainsert=$this->Returcustomer_Service->editdata($data);
   }
   ...
   public function detailAction() {
		...
		$this->view->data=$this->Returcustomer_Service->getDataSaleCentral($no_invoice_data);
		$temp_salecentral = $this->Returcustomer_Service->getDataSaleCentral($no_invoice_data);
	...
	public function detailreturAction() {
		...
		$this->view->data=$this->Returcustomer_Service->getDataReturPenjualan($no_retur_data);
		$temp_salecentral = $this->Returcustomer_Service->getDataReturPenjualan($no_retur_data);
		$kode_customer = $temp_salecentral[0]['kode_customer'];
		$this->view->data2 = $this->Returcustomer_Service->getdatacustomerid($kode_customer);
		
		$this->view->data3=$this->Returcustomer_Service->getDataDetailReturPenjualan($no_retur_data);
