...
class CashincashoutController extends Zend_Controller_Action
{
	...
	public function kirimdataAction()
	{
		...
		if (isset($_POST['id_akun_in'])) {
			$id_akun_in = $_POST['id_akun_in'];
		}
		if (isset($_POST['nama_akun_in'])) {
			$nama_akun_in = $_POST['nama_akun_in'];
		}
		if (isset($_POST['nama_akun_out'])) {
			$nama_akun_out = $_POST['nama_akun_out'];
		}
		if (isset($_POST['id_akun_out'])) {
			$id_akun_out = $_POST['id_akun_out'];
		}

		if (isset($_POST['no_inout'])) {
			$no_inout = $_POST['no_inout'];
		}
	...
	public function hapusdataAction()
	{
		...
		if (isset($_REQUEST['id_transaksi'])) {
