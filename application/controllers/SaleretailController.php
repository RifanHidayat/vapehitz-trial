...
require_once 'service/Saleretail_Service.php';

class SaleretailController extends Zend_Controller_Action {

    public function init() {
        $registry = Zend_Registry::getInstance();
        $this->auth = Zend_Auth::getInstance();
        $this->Home_Service = Home_Service::getInstance();
		$this->Saleretail_Service = Saleretail_Service::getInstance();
    ...
    public function indexAction() {
        ...
        $this->_helper->layout->setLayout('saleretail-layout');
		
		$this->view->Saleretail_Service = $this->Saleretail_Service;
		
		$this->view->data = $this->Saleretail_Service->getlistsaleretail();
		$this->view->menu = $this->Saleretail_Service->getmenu();
    }
	...
	public function cekdatauserAction(){
		...
		$this->view->user = $this->Saleretail_Service->getDataUser($user_id,$password);
	}
	...
	public function tambahdataAction() {
		...
		$this->view->customer=$this->Saleretail_Service->getCustomer();
		$this->view->warna=$this->Saleretail_Service->getWarna();
		$now = date('dmy');
		$kode_inv = $now;
		$this->view->seq=$this->Saleretail_Service->getNoSeq2($kode_inv);
		$this->view->rek=$this->Saleretail_Service->getRekening();
		$this->view->cash=$this->Saleretail_Service->getCash();
    }
	...
	public function dataatomizerAction(){
		...
		$this->view->data = $this->Saleretail_Service->getlistatomizer();
    }
	...
	public function dataaksesorisAction(){
		...
		$this->view->data = $this->Saleretail_Service->getlistaccessories();
    }
	...
	public function datadeviceAction(){
		...
		$this->view->data = $this->Saleretail_Service->getlistdevice();
    }
	...
	public function dataliquidAction(){
		...
		$this->view->data = $this->Saleretail_Service->getlistliquid();
    }
	...
	public function kirimdataAction() { 
		...
		$this->view->datainsert=$this->Saleretail_Service->insertdata($data);
   }
   ...
   public function kirimdatarevisiAction() { 
		...
		$this->view->datainsert=$this->Saleretail_Service->revisidata($data);
   }
   ...
   public function hapusdataAction(){
		...
		$hasil = $this->Saleretail_Service->hapusData($dataInput);
	...
	public function editdataAction() {
		...
		$this->view->data=$this->Saleretail_Service->getDatasaleretail($no_invoice_data);
		$temp_saleretail = $this->Saleretail_Service->getDatasaleretail($no_invoice_data);
		$this->view->no_invoice_revisi=$this->Saleretail_Service->getDataNoInvoiceRevisi($no_invoice_data);
		//$kode_customer = $temp_saleretail[0]['kode_customer'];
		//$this->view->data2 = $this->Saleretail_Service->getdatacustomerid($kode_customer);
		
		$this->view->data3=$this->Saleretail_Service->getDataDetailsaleretail($no_invoice_data);
		
		$this->view->customer=$this->Saleretail_Service->getCustomer();
		$this->view->warna=$this->Saleretail_Service->getWarna();
		$this->view->seq=$this->Saleretail_Service->getNoSeq();
		$this->view->rek=$this->Saleretail_Service->getRekening();
		$this->view->cash=$this->Saleretail_Service->getCash();
    }
	...
	public function printsaleretailAction() {
        $this->_helper->layout->setLayout('target-column');
	...
	public function kirimdataeditAction() { 
		...
		$this->view->datainsert=$this->Saleretail_Service->editdata($data);
   }
   ...
   public function approvalAction() {
	...
	public function kirimdataapproveAction() { 
		...
		$this->view->datainsert=$this->Saleretail_Service->approvedata($data);
   }
   ...
   public function kirimdataapprove2Action() { 
		...
		$this->view->datainsert=$this->Saleretail_Service->approvedata2($data);
   }
