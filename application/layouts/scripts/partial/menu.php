...
<aside>
	<div id="sidebar" class="nav-collapse">
		...
		$ket_menu = '';
		$source = '';
		if (isset($this->menu[0]['ket_menu'])) {
			$ket_menu = $this->menu[0]['ket_menu'];
		}
		if (isset($this->menu[0]['source'])) {
		...
		<ul class="sidebar-menu" id="nav-accordion">
			...
			<?php if ($serialize_permission) {
				if (
					in_array('viewSupplier', $serialize_permission) or
					...
					<li class="sub-menu" id='2'>
						...
						<ul class="sub">
							...
							<?php if ($serialize_permission) {
								if (in_array('viewSales', $serialize_permission)) { ?>
			...
			<?php if ($serialize_permission) {
				if (
					in_array('viewOrderCentral', $serialize_permission) or
					...
					<li class="sub-menu">
						...
						<ul class="sub">
							...
							<?php if ($serialize_permission) {
								if (in_array('viewSaleCentral', $serialize_permission)) { ?>
									<li <?php if ($source == "salecentral") echo "class='active'"; ?>><a href="<?= $this->baseUrl(); ?>/salecentral">Penjualan Barang</a></li>
							<?php }
							} ?>
							<?php if ($serialize_permission) {
								if (in_array('viewPembayaranCustomer', $serialize_permission)) { ?>
									<li <?php if ($source == "pembayarancustomer") echo "class='active'"; ?>><a href="pembayarancustomer">Pembayaran Pelanggan (Piutang)</a></li>
							<?php }
							} ?>
							<?php if ($serialize_permission) {
								if (in_array('viewReturCustomer', $serialize_permission)) { ?>
									<li <?php if ($source == "returcustomer") echo "class='active'"; ?>><a href="returcustomer">Retur Barang Penjualan</a></li>
							<?php }
							} ?>
							<?php if ($serialize_permission) {
								if (in_array('viewPenyelesaianPenjualan', $serialize_permission)) { ?>
							...
							<?php if ($serialize_permission) {
								if (in_array('viewSopGudang', $serialize_permission)) { ?>
									<li <?php if ($source == "sopgudang") echo "class='active'"; ?>><a href="sopgudang">Stock Opname</a></li>
							<?php }
							} ?>
							<?php if ($serialize_permission) {
								if (in_array('viewBadstockGudang', $serialize_permission)) { ?>
							...
							<?php if ($serialize_permission) {
								if (in_array('viewReqtoRetail', $serialize_permission)) { ?>
									<li <?php if ($source == "reqtoretail") echo "class='active'"; ?>><a href="reqtoretail">Permintaan ke Retail</a></li>
							<?php }
							} ?>
							<?php if ($serialize_permission) {
								if (in_array('viewReqtoStudio', $serialize_permission)) { ?>
							...
							<?php if ($serialize_permission) {
								if (in_array('viewApprvCentral', $serialize_permission)) { ?>
			...
			<?php if ($serialize_permission) {
				if (
					in_array('viewApprvRetail', $serialize_permission) or
			...
			<?php if ($serialize_permission) {
				if (
					in_array('viewApprvStudio', $serialize_permission) or
			...
			<?php if ($serialize_permission) {
				if (
					in_array('viewVolLiquid', $serialize_permission) or
				...
				if (
					...
					<li class="sub-menu">
						...
						<ul class="sub">
							...
							<?php if ($serialize_permission) {
								if (in_array('viewUsers', $serialize_permission)) { ?>
									<li <?php if ($source == "user") echo "class='active'"; ?>><a href="user">Data User</a></li>
							<?php }
							} ?>
							<?php if ($serialize_permission) {
								if (in_array('viewGntPassword', $serialize_permission)) { ?>
