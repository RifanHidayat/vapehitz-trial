...
/* 		if($currentGroupPage > 1)
		...
		/* if($currentGroupPage < $totalGroup)
		{
			...
			if ($currentPage <= $totalPages)
			{
				...
				$a = $totalPages;
				//$keluaran =  $keluaran . "<div class=\"page\"><a href=\"#viewDetail\" idreg='$req_id' svr='$req_svr' currentPage='$a' ctgr='$ctgr' key='$key' sdate='$sdate' edate='$edate' nametitle= \"$LanguangeName\">&nbsp;&nbsp;>></a></div>";
				$keluaran =  $keluaran . "&nbsp;<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage('$modul','$fungsi','$a','$param1','$param2','$param3','$param4');\">&#62;&#62;<span class=\"page-sep\"> </span></a>&nbsp;";
			}
		}	
...
/* 		if($currentGroupPage > 1)
	...
	public function showPage3($totalData, $numToDisplay, $currentPage, $modul, $fungsi, $param1, $param2, $param3, $param4, $param5, $param6, $divId)
	{
		...
		{
			$keluaran = $keluaran." 	 	<a title=\"Klik untuk langsung ke halaman ... \" onclick=\"jumpto3('$modul','$totalPages','$fungsi', '$param1', '$param2', '$param3', '$param4', '$param5', '$param6', '$divId'); return false;\" href=\"#pageCursor\">Halaman $currentPage dari $totalPages</a> : ";			
		}
		...
		if($currentPage > 1)
		{
			...
			$a = 1;
			//$keluaran =  $keluaran . "<div class=\"pageFL\"><a href=\"#viewDetail\" idreg='$req_id' svr='$req_svr' currentPage='$a' ctgr='$ctgr' key='$key' sdate='$sdate' edate='$edate' nametitle= \"$LanguangeName\">&nbsp;&nbsp;<<</a></div>";
			$keluaran =  $keluaran . "&nbsp;<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage3('$modul','$fungsi','$a','$param1','$param2','$param3','$param4', '$param5', '$param6', '$divId');\"><strong>&#60;&#60;</strong><span class=\"page-sep\"> </span></a>&nbsp;";
		}
...
/* 		if($currentGroupPage > 1)
		...
		if($totalPages <= $indexEndPage)
		{
			...
			for($a=$indexStartPage; $a <= $totalPages; $a ++)
			{
				...
				{
					//$keluaran =  $keluaran . "<div class=\"page\"><a href=\"#viewDetail\" idreg='$req_id' svr='$req_svr' currentPage='$a' ctgr='$ctgr' key='$key' sdate='$sdate' edate='$edate' nametitle= \"$LanguangeName\">&nbsp;$a&nbsp;</a></div>";		
					$keluaran =  $keluaran . "<span><a href=\"#pageCursor\" onClick=\"javascript:gantinewPage3('$modul','$fungsi','$a','$param1','$param2','$param3','$param4', '$param5', '$param6', '$divId');\">&nbsp;$a&nbsp;</a><span class=\"page-sep\"> </span></span>";
				}
			}
			...
			if($currentPage < $totalPages)
			{
				$a = $currentPage +1;
				//$keluaran =  $keluaran . "<div class=\"page\"><a href=\"#viewDetail\" idreg='$req_id' svr='$req_svr' currentPage='$a' ctgr='$ctgr' key='$key' sdate='$sdate' edate='$edate' nametitle= \"$LanguangeName\">&nbsp;>&nbsp;</a></div>";
				$keluaran =  $keluaran . "<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage3('$modul','$fungsi','$a','$param1','$param2','$param3','$param4', '$param5', '$param6', '$divId');\"><strong>&#62;</strong></a>";
			}
		}
		else
		{
		...
		/* if($currentGroupPage < $totalGroup)
		{
			...
			if ($currentPage <= $totalPages)
			{
				...
				$a = $totalPages;
				//$keluaran =  $keluaran . "<div class=\"page\"><a href=\"#viewDetail\" idreg='$req_id' svr='$req_svr' currentPage='$a' ctgr='$ctgr' key='$key' sdate='$sdate' edate='$edate' nametitle= \"$LanguangeName\">&nbsp;&nbsp;>></a></div>";
				$keluaran =  $keluaran . "&nbsp;<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage3('$modul','$fungsi','$a','$param1','$param2','$param3','$param4', '$param5', '$param6', '$divId');\">&#62;&#62;<span class=\"page-sep\"> </span></a>&nbsp;";
			}
		}	
...
/* 		if($currentGroupPage > 1)
	...
	//echo "param1= ".$param1."<br>"."param2= ".$param2."<br>"."param3= ".$param3."<br>"."param4= ".$param4."<br>"."param5= ".$param5."<br>";
		...
		{
			$keluaran = $keluaran." 	 	<a title=\"Klik untuk langsung ke halaman ... \" onclick=\"jumpto10('$modul','$totalPages','$fungsi', '$param1', '$param2', '$param3', '$param4', '$param5', '$param6', '$param7', '$param8', '$param9', '$param10', '$param11'); return false;\" href=\"#pageCursor\">Halaman $currentPage dari $totalPages</a> : ";			
		}
		...
		if($currentPage > 1)
		{
			...
			$a = 1;
			//$keluaran =  $keluaran . "<div class=\"pageFL\"><a href=\"#viewDetail\" idreg='$req_id' svr='$req_svr' currentPage='$a' ctgr='$ctgr' key='$key' sdate='$sdate' edate='$edate' nametitle= \"$LanguangeName\">&nbsp;&nbsp;<<</a></div>";
			$keluaran =  $keluaran . "&nbsp;<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage10('$modul','$fungsi','$a','$param1','$param2','$param3','$param4','$param5','$param6', '$param7', '$param8', '$param9', '$param10', '$param11');\"><strong>&#60;&#60;</strong><span class=\"page-sep\"> </span></a>&nbsp;";
		}
...
/* 		if($currentGroupPage > 1)
		...
		if($totalPages <= $indexEndPage)
		{
			...
			for($a=$indexStartPage; $a <= $totalPages; $a ++)
			{
				...
				{
					//$keluaran =  $keluaran . "<div class=\"page\"><a href=\"#viewDetail\" idreg='$req_id' svr='$req_svr' currentPage='$a' ctgr='$ctgr' key='$key' sdate='$sdate' edate='$edate' nametitle= \"$LanguangeName\">&nbsp;$a&nbsp;</a></div>";		
					$keluaran =  $keluaran . "<span><a href=\"#pageCursor\" onClick=\"javascript:gantinewPage10('$modul','$fungsi','$a','$param1','$param2','$param3','$param4','$param5','$param6', '$param7', '$param8', '$param9', '$param10', '$param11');\">&nbsp;$a&nbsp;</a><span class=\"page-sep\"> </span></span>";
				}
			}
			...
			if($currentPage < $totalPages)
			{
				$a = $currentPage +1;
				//$keluaran =  $keluaran . "<div class=\"page\"><a href=\"#viewDetail\" idreg='$req_id' svr='$req_svr' currentPage='$a' ctgr='$ctgr' key='$key' sdate='$sdate' edate='$edate' nametitle= \"$LanguangeName\">&nbsp;>&nbsp;</a></div>";
				$keluaran =  $keluaran . "<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage10('$modul','$fungsi','$a','$param1','$param2','$param3','$param4','$param5','$param6', '$param7', '$param8', '$param9', '$param10', '$param11');\"><strong>&#62;</strong></a>";
			}
		}
		else
		{
		...
		/* if($currentGroupPage < $totalGroup)
		{
			...
			if ($currentPage <= $totalPages)
			{
				...
				$a = $totalPages;
				//$keluaran =  $keluaran . "<div class=\"page\"><a href=\"#viewDetail\" idreg='$req_id' svr='$req_svr' currentPage='$a' ctgr='$ctgr' key='$key' sdate='$sdate' edate='$edate' nametitle= \"$LanguangeName\">&nbsp;&nbsp;>></a></div>";
				$keluaran =  $keluaran . "&nbsp;<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage10('$modul','$fungsi','$a','$param1','$param2','$param3','$param4','$param5','$param6', '$param7', '$param8', '$param9', '$param10', '$param11');\">&#62;&#62;<span class=\"page-sep\"> </span></a>&nbsp;";
			}
		}	
	...
	public function showPage25($totalData, $numToDisplay, $currentPage, $modul, $fungsi, 
								...
								)
	{
		...
		{
			$keluaran = $keluaran." 	 	<a title=\"Klik untuk langsung ke halaman ... \" onclick=\"jumpto25('$modul','$totalPages','$fungsi', 
																													'$param1', '$param2', '$param3', '$param4', '$param5', 
																													'$param6', '$param7', '$param8', '$param9', '$param10', 
																													'$param11','$param12', '$param13', '$param14', '$param15', 
																													'$param16', '$param17','$param18', '$param19', '$param20', 
																													'$param21', '$param22', '$param23', '$param24', '$param25', '$param26'); return false;\" href=\"#pageCursor\">Halaman $currentPage dari $totalPages</a> : ";			
																							}
		...
		{
			$a = 1;
			$keluaran =  $keluaran . "&nbsp;<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage25('$modul','$fungsi','$a','$param1','$param2','$param3','$param4','$param5','$param6', '$param7', '$param8', '$param9', '$param10',
																										'$param11','$param12', '$param13', '$param14', '$param15', 
																										'$param16', '$param17','$param18', '$param19', '$param20', 
																										'$param21', '$param22', '$param23', '$param24', '$param25', '$param26');\"><strong>&#60;&#60;</strong><span class=\"page-sep\"> </span></a>&nbsp;";
		}
		...
		if($totalPages <= $indexEndPage)
		{
			...
			for($a=$indexStartPage; $a <= $totalPages; $a ++)
			{
				...
				{
					$keluaran =  $keluaran . "<span><a href=\"#pageCursor\" onClick=\"javascript:gantinewPage25('$modul','$fungsi','$a','$param1','$param2','$param3','$param4','$param5','$param6', '$param7', '$param8', '$param9', '$param10', 
																												'$param11','$param12', '$param13', '$param14', '$param15', 
																												'$param16', '$param17','$param18', '$param19', '$param20', 
																												'$param21', '$param22', '$param23', '$param24', '$param25', '$param26');\">&nbsp;$a&nbsp;</a><span class=\"page-sep\"> </span></span>";
				}
			}
			...
			if($currentPage < $totalPages)
			{
				...
				$keluaran =  $keluaran . "<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage25('$modul','$fungsi','$a','$param1','$param2','$param3','$param4','$param5','$param6', '$param7', '$param8', '$param9', '$param10', 
																									'$param11','$param12', '$param13', '$param14', '$param15', 
																									'$param16', '$param17','$param18', '$param19', '$param20', 
																									'$param21', '$param22', '$param23', '$param24', '$param25', '$param26');\"><strong>&#62;</strong></a>";
			}
		}
		else
		{
			...
			if ($currentPage <= $totalPages)
			{
				...
				$keluaran =  $keluaran . "&nbsp;<a href=\"#pageCursor\" onClick=\"javascript:gantinewPage25('$modul','$fungsi','$a','$param1','$param2','$param3','$param4','$param5','$param6', '$param7', '$param8', '$param9', '$param10', 
																													'$param11','$param12', '$param13', '$param14', '$param15', 
																													'$param16', '$param17','$param18', '$param19', '$param20', 
																													'$param21', '$param22', '$param23', '$param24', '$param25', '$param26');\">&#62;&#62;<span class=\"page-sep\"> </span></a>&nbsp;";
			}
		}	
