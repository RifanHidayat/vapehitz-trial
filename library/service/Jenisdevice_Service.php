...
class Jenisdevice_Service {
	...
	public function getmenu() {
        ...
        try {
            $query ="SELECT * from menu where source = 'jenisdevice' ";
	...
	public function getNoSeq() {
        ...
        try {
            $query ="select max(seq) FROM jenisdevice";
	...
	public function getDataLiquid($id_jenis) {
        ...
        try {
            $query ="SELECT * from jenisdevice where id_jenis = '$id_jenis'";
            $result = $db->fetchAll($query);
            return $result;
        } catch (Exception $e) {
            echo $e->getMessage() . '<br>';
	...
	public function editdata(array $data){
		...
		$db->update('jenisdevice',$insdata,$where);
		$db->commit();
	    return 'sukses';
	   } catch (Exception $e) {
         $db->rollBack();
