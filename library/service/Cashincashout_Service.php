...
class Cashincashout_Service
{
    ...
    public function getNoSeq()
    {
        ...
        try {
            $query = "select max(id) as max FROM tb_cashincashout";
    ...
    public function insertdata(array $data)
    {
        ...
        try {
            ...
            $insdata_transaksi_in = array(
                "deskripsi" => "Transaksi In Out " . $data['no_inout'],
                "tgl_transaksi" => $data['tgl_transaksi'],
                "nominal" => $data['nominal'],
                "type" => "Cash In",
                "nama_table" => "tb_cashincashout",
                "id_table" => $data['no_inout'],
                "id_table_original" => $data['no_inout'],
            ...
            $insdata = array(
                "no_inout" => $data['no_inout'],
                "tgl_cashincashout" => $data['tgl_transaksi'],
                "nominal" => $data['nominal'],
                "catatan" => $data['catatan'],
                "akun_in" => $data['id_akun_in'],
                "akun_out" => $data['id_akun_out'],
                "id_transaksi" => $data['no_inout'],
