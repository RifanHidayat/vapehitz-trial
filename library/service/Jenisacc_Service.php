...
class Jenisacc_Service {
	...
	public function getmenu() {
        ...
        try {
            $query ="SELECT * from menu where source = 'jenisacc' ";
	...
	public function getNoSeq() {
        ...
        try {
            $query ="select max(seq) FROM jenisacc";
	...
	public function getDataLiquid($id_jenis) {
        ...
        try {
            $query ="SELECT * from jenisacc where id_jenis = '$id_jenis'";
            $result = $db->fetchAll($query);
            return $result;
        } catch (Exception $e) {
            echo $e->getMessage() . '<br>';
	...
	public function editdata(array $data){
		...
		$db->update('jenisacc',$insdata,$where);
		$db->commit();
	    return 'sukses';
	   } catch (Exception $e) {
         $db->rollBack();
