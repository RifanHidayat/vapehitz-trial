...
class Transaksi_Service{
    ...
    public function getmenu() {
        ...
        try {
            $query ="SELECT * from menu where source = 'transaksi' ";
    ...
    public function getlistliquid() {
        ...
        try {
            $query ="SELECT *,transaksi.id as id_transaksi,akun.id as id_akun,transaksi.type as type_transaksi from transaksi  JOIN akun on transaksi.id_akun=akun.id order by transaksi.id ASC ";
            $result = $db->fetchAll($query);
            return $result;
        } catch (Exception $e) {
            echo $e->getMessage() . '<br>';
